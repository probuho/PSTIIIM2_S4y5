    ...
    <div className="min-h-screen flex items-center justify-center bg-white pt-0">
      <div className="w-full max-w-[98vw] min-h-[600px] bg-white rounded-3xl shadow-2xl flex overflow-hidden mx-0">
        ...
        <div className="w-1/2 flex flex-col justify-center items-center bg-[#7da6fa] rounded-r-3xl text-white p-3">
          <h2 className="text-3xl font-extrabold mb-2 text-center">¡Bienvenido de nuevo!</h2>
          <p className="mb-8 text-lg text-center">¿Ya tienes una cuenta?</p>
          <Link to="/login" className="border-2 border-white rounded-lg px-8 py-2 font-semibold hover:bg-white hover:text-blue-500 transition-colors">Iniciar sesión</Link>
        </div>
      </div>
    </div>
  );
